...
I'm **Stijn**, a software engineer focused on building production-grade tools and systems. I work across the full stack — from low-level Java networking to TypeScript frontends — with a strong interest in open source, performance engineering, and developer tooling.
...
|--------|-------------|----------|
| [**NetworkDataAPI**](https://github.com/7txr/NetworkDataAPI) | Production-grade data synchronization solution for large Minecraft networks, backed by MongoDB | Java |
| [**YEETIFF**](https://github.com/7txr/YEETIFF) | Yet Even Extremely Expressier Transcoded Image File Format | Python |
| [**Parallel**](https://github.com/7txr/Parallel) | Minecraft plugin giving players dual parallel inventories with tactical switching | Java |
| [**MemoryMobs**](https://github.com/7txr/MemoryMobs) | Minecraft mobs with real memory & evolving behavior | Java |
